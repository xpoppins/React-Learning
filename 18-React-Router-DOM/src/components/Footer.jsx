...
const Footer = () => {
  return (
//    <nav className='flex items-center justify-between bg-green-700 w-full px-8 py-20 text-white'>
      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              ...
              <span className="self-center text-2xl font-bold text-white whitespace-nowrap">Sumit Kumar </span>
            
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-green-100 uppercase">Resources</h2>
              <ul className="text-green-50 font-medium">
                <li className="mb-4">
                  <a href="https://flowbite.com/" className="hover:underline">REACT ROUTER DOM</a>
                </li>
                <li>
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold text-green-100 uppercase">Follow us</h2>
              <ul className="text-green-50 font-medium">
                <li className="mb-4">
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold text-green-100 uppercase">Legal</h2>
              <ul className="text-green-50 font-medium">
                <li className="mb-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-green-100 sm:text-center">
            © 2026 <a href="#" className="hover:underline">learning MERN™</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a href="#" className="text-green-200 hover:text-white ms-5">
              <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
